            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-3">
                        ...
                        <button
                            type="submit"
                            className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:shadow-lg transition-shadow"
                        >
                            Create Campaign
                        </button>
                    </div>
                        ...
                        <table className="w-full">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    ...
                                    <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700">Voice Type</th>
                                    <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700">Start Time</th>
